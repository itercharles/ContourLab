    ...
    <div className="flex flex-none flex-col border-b border-[#2a2a2a] bg-[#111]">
      <div className="flex h-9 items-center gap-2 border-b border-[#24292f] bg-[#181b20] px-2">
        ...
        <button
          ...
          aria-label="Undo"
          className="flex h-7 w-7 items-center justify-center rounded bg-[#252b33] text-[#a0a7b0] transition-colors hover:bg-[#1f242b] hover:text-[#e6e9ed] disabled:cursor-not-allowed disabled:opacity-30"
        >
        ...
        <button
          ...
          title="Not implemented"
          aria-label="Share"
          className="flex h-7 w-7 cursor-not-allowed items-center justify-center rounded bg-[#252b33] text-[#404040]"
        >
        ...
        <Link
          ...
          title="Settings"
          aria-label="Settings"
          className="flex h-7 w-7 items-center justify-center rounded bg-[#252b33] text-[#a0a7b0] transition-colors hover:bg-[#1f242b] hover:text-[#e6e9ed] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
        >
          <svg aria-hidden="true" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
