import { parseDicomTags, buildImageMetadata, buildMetadata, DicomMetadataStore } from './DicomMetadataStore';
    ...
    await Promise.all(
      batch.map(async (file) => {
        try {
          ...
          DicomMetadataStore.setImageMetadata(imageId, buildImageMetadata(tags));
