...
describe('importRtstructDataset @links:SRS-010,SYS-007,CRS-006', () => {
  it('maps RTSTRUCT ROI sequences into a ContourLab structure set @testing:T1', () => {
  ...
  it('leaves volume_cc at 0 when no slice thickness is provided @testing:T2', () => {
    const structureSet = importRtstructDataset(
      {
  ...
  it('computes volume_cc for a single 10mm-square contour with 5mm slice thickness @testing:T3', () => {
  ...
  it('sums volume_cc across multiple contour slices @testing:T3', () => {
  ...
  it('computes volume_cc per structure when multiple ROIs are imported @testing:T4', () => {
