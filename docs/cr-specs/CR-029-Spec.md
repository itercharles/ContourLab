...
See specification: [CR-029-Spec.md](../../ContourLab-DHF/docs/cr-specs/CR-029-Spec.md)
...
python -m compliantflow --dhf DHF dhf item get CR-029 | grep status
gh pr list --head develop/CR-029 --repo itercharles/ContourLab-DHF
...
| All GitHub Actions jobs succeeded | ✓ Verify with `gh run list --repo itercharles/ContourLab-DHF` |
