...
2. Transition CR-031 to `completed`:
   ...
   medharness --dhf DHF dhf item transition CR-031 completed --by "ImplementationAgent"
...
| CR-031 state is `completed` | ✓ Verify with `medharness --dhf DHF dhf item get CR-031` |
